...
class MtrlAmEnvCfg(DirectRLEnvCfg):
    ...
    ee_target_roll_min: float = -math.pi * 7.0 / 18.0
    ee_target_roll_max: float = +math.pi * 2.0 / 18.0
    ee_target_pitch_min: float = -math.pi * 10.0 / 18.0
    ee_target_pitch_max: float = +math.pi * 2.0 / 18.0
